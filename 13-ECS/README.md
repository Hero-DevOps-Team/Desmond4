...
- [Lesson 13.3: Elastic Container Service - Fargate ECS](#lesson-133--elastic-container-service---fargate-ecs)
  ...
  - [Retrospective 13.3](#retrospective-133)
    ...
    - [Question: Fargate volume/bind mounts](#question--fargate-volume-bind-mounts)
...
- Tag the repository with your Stelligent labs account name.
...
_nginx_ web server container. This is a long and complicated sequence of labs. If
you get stuck, feel free to reach out to your mentor and refer to documentation.
