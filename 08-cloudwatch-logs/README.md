...
of the
[stelligent-nu](https://github.com/stelligent/stelligent-nu)
repo:
...
You'll need jorgebastida/awslogs in Lesson 8.2.1, so now's a good time to
install it on your laptop. You may find that it's handy for client
engagements and future lab work as well.
...
- Add tags that mark it with your AWS username, and identify it as a
  stelligent-nu resource with this topic and lab number.
