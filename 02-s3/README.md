...
- [Lesson 2.1: Introduction to S3 with awscli](#lesson-21-introduction-to-s3-with-awscli)
  ...
  - [Practice 2.1](#practice-21)
    ...
    - [Lab 2.1.3: Exclude Private Objects When Uploading to a Bucket](#lab-213-exclude-private-objects-when-uploading)
...
- [Lesson 2.3: S3 Versioning and Lifecycle Policies](#lesson-23-s3-versioning-and-lifecycle-policies)
  ...
  - [Practice 2.3](#practice-23)
    ...
    - [Lab 2.3.2: Object Versions](#lab-232-object-versions)
      - [Question: Deleted Object Versions](#duestion-deleted-object-versions)
      - [Question: Deleting All Versions](#duestion-deleting-all-versions)
...
push your changes to it, and when you complete a section, you should
issue a pull request to your mentor. Consider this pattern "assumed" for
...
- Call the bucket "stelligent-_your-AWS-username_".
...
CLI & CloudFormation. In your engagements, you're much more likely to
...
Discuss with your mentor and the other onboarding engineers:
